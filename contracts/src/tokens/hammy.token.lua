...
if Name ~= 'Sad Hamster' then Name = 'Sad Hamster' end

if Ticker ~= 'HAMMY' then Ticker = 'HAMMY' end

if Denomination ~= 10 then Denomination = 10 end

if not Logo then Logo = nil end
    ...
    function(msg)
        ...
        ao.send({
            ...
            Tags = {
                --[[
                    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                    TODO: THIS SHOULD BE Account = <Tags.Target or msg.From>
                    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                ]] --
                Target = msg.From,
                Balance = bal,
...
Handlers.add(
    ...
    function(msg)
        ...
        --[[
            !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            TODO: REKT! QUANTITITY MUST BE POSITIVE! The example doesn't check that.
            !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ]] --
        ...
        if Balances[msg.From] >= qty then
            ...
            ao.send({
                -- TODO: Should't this be msg.From?
